...
// card select color 
let color = document.querySelectorAll(".selectColor div span");
 let nameColor = document.querySelector(".color p span");
color.forEach((ele) => {
    ele.addEventListener("click", () => {
        color.forEach(item => item.classList.remove("active"));
       
        ele.classList.add("active");
        if (ele.classList.contains("active") && ele.classList.contains("red")) {
            nameColor.innerHTML = "Red"
        }
        if (ele.classList.contains("active") && ele.classList.contains("blue")) {
            nameColor.innerHTML = "Blue"
        }
        if (ele.classList.contains("active") && ele.classList.contains("green")) {
            nameColor.innerHTML = "Green"
        }
        if (ele.classList.contains("active") && ele.classList.contains("black")) {
            nameColor.innerHTML = "Black"
        }
        if (ele.classList.contains("active") && ele.classList.contains("gray")) {
            nameColor.innerHTML = "Gray"
        }
    })
